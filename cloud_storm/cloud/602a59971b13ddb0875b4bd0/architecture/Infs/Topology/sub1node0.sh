...
apt-get install -y sawtooth-raft-engine sawtooth-pbft-engine python3-sawtooth-poet-cli
apt-get install -y python3-sawtooth-poet-engine python3-sawtooth-poet-families
sawtooth keygen
sawadm keygen
...
bind = ["network:tcp://null:8800","component:tcp://127.0.0.1:4004","consensus:tcp://127.0.0.1:5050"]
peering = "static"
endpoint = "tcp://null:8800"
peers = ["tcp://192.168.10.10:8800"]
scheduler = 'parallel'
